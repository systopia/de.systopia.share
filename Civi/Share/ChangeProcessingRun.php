...
/**
 * Class ChangeProcessingRun
 *
 * Will coordinate a processing run
 */
class ChangeProcessingRun extends Event
{
    /** Symfony event name for the module registration */
    const EVENT_NAME = 'civi.share.change.process';

    /** @var array list of change data */
    protected $changes = [];
