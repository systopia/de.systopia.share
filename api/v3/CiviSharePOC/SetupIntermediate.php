...
function _civicrm_api3_civi_share_p_o_c_setup_intermediate_spec(&$spec) {
  $spec['clear'] = [
...
function civicrm_api3_civi_share_p_o_c_setup_intermediate(&$params) {
  ...
  // Create peering between intermediate and central instances.
  ...
  $nodePeeringCentral = \Civi\Api4\ShareNodePeering::create(FALSE)
    ->addValue('local_node', $intermediateNode['id'])
    ->addValue('remote_node', $centralNode['id'])
    // TODO: Enable if needed.
    ->addValue('is_enabled', FALSE)
