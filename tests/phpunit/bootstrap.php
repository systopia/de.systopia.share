...
// Make CRM_Share_ExtensionUtil available.
require_once __DIR__ . '/../../share.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.share');
 ...
 */
function _share_test_civicrm_container(ContainerBuilder $container): void {
}
